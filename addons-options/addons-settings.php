								...
								<div class="inner">
									<div class="header-wrap">
										...
										<div class="right-status-text">
											...
											if ( $installed && $active ) {
												?>
												<span class="active-text"> <?php esc_html_e( 'Active', 'surelywp-services' ); ?> </span>
											<?php } elseif ( $installed && ! $active ) { ?>
												<span class="in-active-text"> <?php esc_html_e( 'Inactive', 'surelywp-services' ); ?> </span>
											<?php } else { ?>
												<span class="not-install-text"> <?php esc_html_e( 'Not Installed', 'surelywp-services' ); ?> </span>
											<?php } ?>
									...
									<div class="addons-btn-wrap">
										...
										if ( $installed && $active ) {
											...
											<a href="<?php echo esc_url( $url ); ?>" class="button-primary surelywp-ric-settings-save">
												...
												<?php esc_html_e( 'Manage', 'surelywp-services' ); ?>
											</a>
										<?php } elseif ( $installed && ! $active ) { ?>
											<a href="<?php echo esc_url( $url_activate ); ?>" data-slug="<?php esc_attr( $plugin_path ); ?>" class="button-primary surelywp-active surelywp-ric-settings-save">
												...
												<?php esc_html_e( 'Activate', 'surelywp-services' ); ?>
											</a>
											...
											<a href="<?php echo esc_url( $endpoint_url ); ?>" target="_blank" class="button-primary surelywp-ric-settings-save">
												...
												<?php esc_html_e( 'Purchase', 'surelywp-services' ); ?>
											</a>
										<?php } ?>
